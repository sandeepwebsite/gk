...
const articleTexts = {
 ...
 '79': 'Parliament shall consist of the President and two Houses.',
...
function showAnswer(correct) {
 ...
 document.querySelectorAll(".option").forEach(opt => {
  if (opt.innerText === correct) opt.style.background = "#3ae374";
 });
 nextBtn.style.display = "inline-block";
}
